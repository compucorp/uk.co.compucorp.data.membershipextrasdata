 ...
 */
class CRM_Membershipextrasdata_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Membershipextrasdata_Upgrader(
        'uk.co.compucorp.data.membershipextrasdata',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_Membershipextrasdata_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
